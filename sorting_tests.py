...
from algorithms.sorting import BubbleSort, InsertSort, MergeSort, QuickSort, SelectionSort
...
class TestSortFunction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sort_functions = [SelectionSort, InsertSort, BubbleSort, MergeSort, QuickSort]
